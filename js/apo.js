...
window.addEventListener("load", function () {
  var selectCountry = document.getElementById("countySel1"),
    selectState = document.getElementById("stateSel1"),
    countrystatecitySelect = document.getElementById("districtSel1");
  ...
  selectState.onchange = function () {
    countrystatecitySelect.length = 1; // delete all options bar earliest
    if (this.selectedIndex < 1) return; // done
    var region = countryObject[selectCountry.value][this.value];
...
function disableState1() {
  if (document.getElementById("selCountry").value !== "NP") {
    // document.getElementById("txtCustomerStates").disabled='false';
    document.getElementById("hide_p").style.display = "none";
    document.getElementById("hide_d").style.display = "none";
    document.getElementById("hide_m").style.display = "none";
    document.getElementById("wnumber1").style.display = "none";
    document.getElementById("citytown1").style.display = "none";
    document.getElementById("foraddress").style.display = "block";
  } else {
    document.getElementById("hide_p").style.display = "block";
    document.getElementById("hide_d").style.display = "block";
    document.getElementById("hide_m").style.display = "block";
    document.getElementById("wnumber1").style.display = "block";
    document.getElementById("citytown1").style.display = "block";
    document.getElementById("foraddress").style.display = "none";
  }
}
document.getElementById("other").style.display = "none";
function disableThrough() {
  if (document.getElementById("through").value == "OT") {
    document.getElementById("other").style.display = "block";
  } else {
    document.getElementById("other").style.display = "none";
  }
}
document.getElementById("otherGotra").disabled = "true";
function changeGotra() {
  if (document.getElementById("mygotra").value == "otherG") {
    document.getElementById("otherGotra").disabled = false;
  } else {
    document.getElementById("otherGotra").disabled = "true";
  }
}
...
$(".payus").click(function () {
  // If the clicked element has the active class, remove the active class from EVERY .nav-link>.state element
  if ($(this).hasClass("act")) {
    $(".payus").removeClass("act");
  }
...
document.getElementById("fee-list1").style.display = "none";
document.getElementById("fee-list2").style.display = "none";
function optionChange() {
  if (document.getElementById("myoption").value == "op1") {
    document.getElementById("fee-list1").style.display = "block";
    document.getElementById("fee-list2").style.display = "none";
  } else if (document.getElementById("myoption").value == "op2") {
    document.getElementById("fee-list2").style.display = "block";
    document.getElementById("fee-list1").style.display = "none";
  } else {
    document.getElementById("fee-list1").style.display = "none";
    document.getElementById("fee-list2").style.display = "none";
